  ...
  return (
    ...
    >
      <div className="flex justify-end">
        <button
          className="flex mt-3 mr-3 w-8 h-8 bg-gray-700 rounded-lg text-gray-300"
      ...
      <div>
        {!isCollapsed && (
          <div className="text-2xl text-gray-400 font-bold border-t border-gray-400 border-b mt-2 p-1.5 mb-3">
            Course: {course.title}
          </div>
        )}
      </div>
              ...
              <div>
                {eachSection.videoSection.map((eachVideo) => (
                  <div
                    key={eachVideo.id}
                    className={clsx(
                      "mb-1 bg-gray-800 mt-5 p-2 rounded-lg h-[46px]",
                  ...
                  >
                    <div className="flex hover:font-semibold text-xl justify-between items-center text-gray-200 cursor-pointer">
